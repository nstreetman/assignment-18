...
function renderContentTo(domEl, theRoute, theContent) {
	...
	//Flights Section//
	if (theRoute === 'flights') {
		var fetchArrivalsPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=arrivals');
		var fetchDeparturesPromise = _jquery2.default.getJSON('http://apis.is/flight?language=en&type=departures');
		_jquery2.default.when(fetchArrivalsPromise, fetchDeparturesPromise).then(function (arrivalsData, departureData) {
